...
describe('ProductList', () => {
  it('should render the product list correctly', () => {
    ...
    expect(getByText('Product 1')).toBeOnTheScreen();
    expect(getByText('ID: 123')).toBeOnTheScreen();
    expect(getByText('Product 2')).toBeOnTheScreen();
    expect(getByText('ID: 124')).toBeOnTheScreen();
  });

  it('should render no products message when the list is empty', () => {
    const { getByText } = render(<ProductList products={[]} />);
    
    expect(getByText('No hay productos disponibles')).toBeOnTheScreen();
  });
  ...
  it('should render no products found message when filter does not match', () => {
    ...
    expect(getByText('No se encontraron productos')).toBeOnTheScreen();
  });
  ...
  it('should filter products based on the filter prop', () => {
    ...
    expect(queryByText('Product 1')).toBeOnTheScreen();
    expect(queryByText('ID: 123')).toBeOnTheScreen();
